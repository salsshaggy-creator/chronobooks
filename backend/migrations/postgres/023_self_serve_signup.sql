...
ALTER TABLE companies ADD COLUMN self_serve BOOLEAN NOT NULL DEFAULT false;
ALTER TABLE companies ADD COLUMN setup_completed BOOLEAN NOT NULL DEFAULT true;
ALTER TABLE companies ADD COLUMN requested_plan_name TEXT;
ALTER TABLE companies ADD COLUMN plan_requested_at TIMESTAMPTZ;
