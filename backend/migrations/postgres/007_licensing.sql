...
ALTER TABLE companies ADD COLUMN license_activated_at TIMESTAMPTZ;
ALTER TABLE companies ADD COLUMN license_expires_at TIMESTAMPTZ;
ALTER TABLE companies ADD COLUMN license_last_renewed_at TIMESTAMPTZ;
...
ALTER TABLE companies ADD COLUMN procurement_enabled BOOLEAN NOT NULL DEFAULT false;
ALTER TABLE companies ADD COLUMN manufacturing_enabled BOOLEAN NOT NULL DEFAULT false;
ALTER TABLE companies ADD COLUMN pos_enabled BOOLEAN NOT NULL DEFAULT false;
ALTER TABLE companies ADD COLUMN consolidation_enabled BOOLEAN NOT NULL DEFAULT false;
