...
ALTER TABLE companies ADD COLUMN vat_registered BOOLEAN NOT NULL DEFAULT false;
...
ALTER TABLE companies ADD COLUMN withholding_tax_enabled BOOLEAN NOT NULL DEFAULT false;
...
ALTER TABLE companies ADD COLUMN cost_centres_enabled BOOLEAN NOT NULL DEFAULT false;
ALTER TABLE companies ADD COLUMN budgeting_enabled BOOLEAN NOT NULL DEFAULT false;
ALTER TABLE companies ADD COLUMN bank_reconciliation_enabled BOOLEAN NOT NULL DEFAULT false;
ALTER TABLE companies ADD COLUMN inventory_enabled BOOLEAN NOT NULL DEFAULT false;
ALTER TABLE companies ADD COLUMN fixed_assets_enabled BOOLEAN NOT NULL DEFAULT false;
ALTER TABLE companies ADD COLUMN payroll_integration_enabled BOOLEAN NOT NULL DEFAULT true;
