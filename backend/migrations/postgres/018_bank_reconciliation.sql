...
CREATE TABLE bank_reconciliations (
  ...
  -- created_at's resolution -- two reconciliations completed close together must still
  -- have an unambiguous order, since each one's balancing math depends on knowing
  -- exactly what the previous one reconciled to.
  seq INTEGER NOT NULL,
  statement_date TEXT NOT NULL,
  statement_balance NUMERIC(18,2) NOT NULL,
  book_balance NUMERIC(18,2) NOT NULL,
  cleared_total NUMERIC(18,2) NOT NULL,
  outstanding_total NUMERIC(18,2) NOT NULL,
