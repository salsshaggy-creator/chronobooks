...
ALTER TABLE invoices ADD COLUMN exchange_rate NUMERIC NOT NULL DEFAULT 1;
ALTER TABLE invoices ADD COLUMN foreign_total NUMERIC;

ALTER TABLE bills ADD COLUMN currency TEXT;
ALTER TABLE bills ADD COLUMN exchange_rate NUMERIC NOT NULL DEFAULT 1;
ALTER TABLE bills ADD COLUMN foreign_total NUMERIC;

ALTER TABLE expenses ADD COLUMN currency TEXT;
ALTER TABLE expenses ADD COLUMN exchange_rate NUMERIC NOT NULL DEFAULT 1;
ALTER TABLE expenses ADD COLUMN foreign_total NUMERIC;
